      ...
      {!loading && result && (
        <div>
          ...
          >
            <li className="grid-item">
              <span className="custom-text">
                {result.meta.content.plain_text_size} KB
              </span>
              <br></br> Plain Text Size
            </li>
            <li className="grid-item">
              <span className="custom-text">
                {result.meta.content.plain_text_rate.toFixed(5)}
              </span>
              <br></br> Plain Text Rate
            </li>
            <li className="grid-item">
              <span className="custom-text">
                {result.meta.content.plain_text_word_count}
              </span>
              <br></br> Plain Text Word Count
            </li>
            <li className="grid-item">
              <span className="custom-text">
                {result.meta.content.automated_readability_index.toFixed(5)}
              </span>
              <br></br> Automated Readability Index
            </li>
            <li className="grid-item">
              <span className="custom-text">
                {result.meta.content.coleman_liau_readability_index.toFixed(5)}
              </span>
              <br></br> Coleman Liau Readability Index
            </li>
            <li className="grid-item">
              <span className="custom-text">
                {result.meta.content.dale_chall_readability_index.toFixed(5)}
              </span>
              <br></br> Dale Chall Readability Index
            </li>
            <li className="grid-item">
              <span className="custom-text">
                {result.meta.content.flesch_kincaid_readability_index.toFixed(
                  5,
                )}
              </span>
              <br></br> Flesch Kincaid Readability Index
            </li>
            <li className="grid-item">
              <span className="custom-text">
                {result.meta.content.smog_readability_index.toFixed(5)}
              </span>
              <br></br> SMOG Readability Index
            </li>
            <li className="grid-item">
              <span className="custom-text">
                {result.meta.content.description_to_content_consistency}
              </span>
              <br></br> Description to Content Consistency
            </li>
            <li className="grid-item">
              <span className="custom-text">
                {result.meta.content.title_to_content_consistency}
              </span>
              <br></br> Title to Content Consistency
            </li>
          </ul>
          <h3 className="section-heading" style={{ fontSize: "30px" }}>
            Page Timing
